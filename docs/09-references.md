...
| **VisA** | Zou, Jeong, Pemula, Zhang, Dabeer. *SPot-the-Difference Self-Supervised Pre-training for Anomaly Detection and Segmentation.* ECCV 2022. [arXiv:2207.14315](https://arxiv.org/abs/2207.14315) · [AWS Open Data](https://registry.opendata.aws/visa) · [split CSV](https://github.com/amazon-science/spot-diff) | ✅ | **The dataset the project runs on.** Availability, size (1.93 GB) and the 1cls split verified directly. Licence stated CC BY 4.0 by AWS and the paper; a third-party source says CC BY-NC-SA — unresolved, stricter reading followed. Read the paper in full before the final report. |
| **BTAD** | beanTech Anomaly Detection, 2021. [download](http://avires.dimi.uniud.it/papers/btad/btad.zip) | ⚠ | 1.23 GB, downloads. **No licence stated on the download page** — resolve with the authors before publishing any derived figure. |
| **KolektorSDD2** | Božič, Tabernik, Skočaj. ViCoS, 2021. [download](https://go.vicos.si/kolektorsdd2) | ⚠ | 0.85 GB, CC BY-NC-SA. Fallback option. |
| **MPDD** | Jezek et al., 2021. [github](https://github.com/stepanje/MPDD) | ⚠ | Planned transfer probe: non-homogeneous backgrounds, varying orientation and lighting, unlike VisA's fixed rig. |
| **Real-IAD / Real-IAD Variety** | CVPR 2024 / 2026. [project](https://realiad4ad.github.io/Real-IAD/) | ⚠ | 151k and 199k images. Application form; worth applying for in parallel rather than waiting on. |
